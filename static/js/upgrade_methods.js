/* Cross-cutting frontend overrides composed by static/app.js.
   This keeps the domain page modules independent while allowing upgraded UX. */
...
export const upgradeMethods = {
  ...
  openReturnFromPOS() { this.nav('invoices'); this.toast('اختر الفاتورة الأصلية ثم اضغط «مرتجع» من تفاصيل الفاتورة', 'info'); const search = document.getElementById('invoicesSearch'); if (search) setTimeout(() => search.focus(), 80); },
